...
<%@ page errorPage = "jsp-2_handle-error.jsp" %>    
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<%
        ...
        if (responseCheck != null ) {
                 ...
                 response.setHeader("Location", "jsp-2_response-redirect.jsp?office=" + responseCheck);
        }
...
%>
<a href="jsp-2_jspImplicitObjects.jsp?office=head_office">Show usage of response object</a><br>
<a href="jsp-2_jspImplicitObjects.jsp?error=1">Show usage of error  object</a><br>
