...
<jsp:useBean id="productBean" class="com.ecommerce_jsp_4.ProductBean" scope="session"></jsp:useBean>
...
<a href="jsp_4_forward.jsp">Use Forward action to go to Google</a><br>
